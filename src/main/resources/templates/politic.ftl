    ...
    <#noparse>
        ...
        <div class="container h-100 "  style="background: #fff;">
            ...
            <h1 class="display-4 mt-5 mb-5" style="padding-top: 50px;">Политика в отношении обработки персональных данных</h1>
                        ...
                        <li class="list-unstyled">Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://endocrinology.ismu.baikal.ru" class="card-link">https://endocrinology.ismu.baikal.ru</a>.</li>
                        </p>
                        ...
                        <li class="list-unstyled"> Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://endocrinology.ismu.baikal.ru" class="card-link">https://endocrinology.ismu.baikal.ru</a>;</li>
                        ...
                        <li class="list-unstyled">Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://endocrinology.ismu.baikal.ru" class="card-link">https://endocrinology.ismu.baikal.ru</a>;</li>
                        <li class="list-unstyled">Пользователь – любой посетитель веб-сайта <a href="https://endocrinology.ismu.baikal.ru" class="card-link">https://endocrinology.ismu.baikal.ru</a>;</li>
                        ...
                        <p class="card-text">Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="https://endocrinology.ismu.baikal.ru" class="card-link">https://endocrinology.ismu.baikal.ru</a>. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.
                        ...
                        Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://endocrinology.ismu.baikal.ru/politic" class="card-link">https://endocrinology.ismu.baikal.ru/politic</a>. </p>
